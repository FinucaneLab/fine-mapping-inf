...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-causal-snps', type=int, default=10, help='Maximum number of large effects in the region')
    parser.add_argument('--method', type=str, help='Comma delimited fine-mapping methods to run, e.g. susieinf,finemapinf')
    ...
    parser.add_argument('--output-prefix', type=str, help='File prefix for output files')
    ...
    if 'susieinf' in methods:
        ...
        susie_output = susie(z, args.meansq, args.n, args.num_causal_snps, LD=None, V=V, Dsq=Dsq,
    ...
    if 'finemapinf' in methods:
        ...
        if args.use_susieinf_tausq:
            ...
            finemap_output = finemap(z, args.meansq, args.n, args.num_causal_snps, LD=None, V=V, Dsq=Dsq,
