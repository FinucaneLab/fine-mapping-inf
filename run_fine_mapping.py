...
if __name__ == '__main__':
    ...
    if 'finemapinf' in methods:
        ...
        if 'susieinf' not in methods or args.est_finemapinf_tausq:
            ...
            logging.info('Using tau-squared %.2E and sigma-squared %.2f generated by SuSiE-inf'%(susie_output['tausq'],susie_output['sigmasq']))
            finemapinf_splash_screen()
            finemap_output = finemap(z, args.meansq, args.n, args.num_sparse_effects, LD=None, V=V, Dsq=Dsq,
                sigmasq=susie_output['sigmasq'], tausq=susie_output['tausq'], pi0=pi0, S=[0.05**2], sched_sss=[10000], n_conv_sss=100,
                nmodels=5000, prob_tol_sss=1e-3, seed=21,models_nbins=None,pairs_nbins=None,verbose=1)
    ...
    print('Total time elapsed %.2f seconds'%(time.time() - t0_total))
